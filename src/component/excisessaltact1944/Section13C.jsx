          ...
          <div className="flex flex-col md:flex-row">
            <div className="p-6">
                <div className="space-y-6 text-justify text-black">
                    ...
                    <div>
                        <p className="mb-4">
                            <span className="text-xl font-bold leading-tight text-gray-950 md:text-xl">৪১জ। বিকল্প বিরোধ নিষ্পত্তির সিদ্ধান্ত---</span> (১) যেই ক্ষেত্রে উভয় পক্ষ বিরোধ সংক্রান্ত কোন ঘটনা বা আইন (Fact or law) সম্পর্কে ঐক্যমত পোষণ করেন, সেই ক্ষেত্রে বিরোধীয় বিষয়ে মতৈক্যের ভিত্তিতে (By agreement) আংশিক অথবা সম্পূর্ণভাবে উহা বিকল্প বিরোধ-নিষ্পত্তি প্রক্রিয়ায় নিষ্পত্তি করা যাইবে।
                        </p>
