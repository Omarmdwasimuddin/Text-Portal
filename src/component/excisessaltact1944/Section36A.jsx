          ...
          <div className="flex flex-col md:flex-row">
            <div className="p-6">
                <div className="space-y-6 text-justify text-black">
                    ...
                    <div>
                        <p className="mb-4">
                            <sup className='text-blue-500 cursor-pointer' title='ধারা ৪১গ অর্থ আইন, ২০১২ এর ৭৪ ধারাবলে প্রতিস্থাপিত ।'>১</sup>[<span className="text-xl font-bold leading-tight text-gray-950 md:text-xl">৪১গ। বিকল্প বিরোধ-নিষ্পত্তির আওতা ও পরিধি---</span> বিকল্প বিরোধ-নিষ্পত্তির আওতা ও পরিধি।- (১) ধারা (২) এর দফা (ণণ) এর অধীন অর্থের মাধ্যমে পরিমাপযোগ্য মূল্য, ধারা ৫ এর অধীন কর ধার্যের জন্য মূল্য নিরূপন এবং ধারা ৮ এর অধীন টার্ণওভার কর নির্ধারণ ও পরিশোধ এবং তদসংক্রান্ত বিধি বা আদেশ বিষয়ে-
                        </p>
