            ...
            <div className="p-6">
              <div className="space-y-6 text-justify text-black">
                ...
                <p className="mb-4 text-sm">
                  <sup className='text-blue-500' title='Section 3B was inserted by section 5 of the Finance Act, 1968 (Act No. XI of 1968)'>1</sup>[<span className='text-sm font-bold leading-tight text-black md:text-sm'>3C. Principle for determination of tariff classification---</span> When for any reason, goods are, prima facie, classifiable under two or more headings of the First Schedule, the heading which provides the most specific description shall be preferred to headings providing a more general description.]
                </p>
              </div>
        ...
        <div className="">
          <div className="p-6">
            ...
            <p className="text-xs italic text-black">
              1. Section 3C was inserted by section 5 of the Finance Ordinance, 1984 (Ordinance No. XLII of 1984) <br/><br/>
            </p>
