            ...
            <div className="p-6">
              <div className="space-y-6 text-justify text-black">
                ...
                <p className="mb-4 text-sm">
                  <sup className='text-blue-500' title='Section 3B was inserted by section 5 of the Finance Act, 1968 (Act No. XI of 1968)'>1</sup>[<span className='text-sm font-bold leading-tight text-black md:text-sm'>3B. Goods particularly composed of dutiable articles</span>--- Goods whereof any article liable to duty under this Act forms a part or ingredient shall be chargeable with the full duty which would be payable on such goods if they were entirely composed of such article, or, if composed of more than one article liable to duty, then with the full duty which would be payable on such goods if they were entirely composed of the article on which the highest amount of duty would be payable.]
                </p>
              </div>
        ...
        <div className="">
          <div className="p-6">
            ...
            <p className="text-xs italic text-black">
              1. Section 3B was inserted by section 5 of the Finance Act, 1968 (Act No. XI of 1968). <br/><br/>
            </p>
