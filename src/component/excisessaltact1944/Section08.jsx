            ...
            <div className="p-6">
              <div className="space-y-6 text-justify text-black">
                ...
                <p className="mb-4 text-sm">
                  <span className='text-sm font-bold leading-tight text-black md:text-sm'>8. Restriction on possession of excisable goods---</span> From such date as may be specified in this behalf by the <sup className='text-blue-500' title='The word “Board” was substituted for the words “National Board of Revenue” by section 5 of the Finance Act, 1979 (Act No. V of 1979)'>1</sup>[Board] by notification in the official Gazette, no person shall, except as provided by rules made under this Act, have in his possession any excisable goods specified in this behalf in Part B of the Second Schedule in excess of such quantity as may be prescribed for the purposes of this section as the maximum amount of such goods or of any variety of such goods which may be possessed at any one time by such a person.
                </p>
              </div>
