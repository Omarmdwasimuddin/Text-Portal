          ...
          <div className="flex flex-col md:flex-row">
            <div className="p-6">
              <div className="space-y-6 text-justify text-black">
                ...
                <div>
                  <p className="mb-4">
                     <span className="text-xl font-bold leading-tight text-gray-950 md:text-xl">৩০৷ বাজেয়াপ্তকৃত পণ্যের ব্যবস্থাপনা---</span>সরকারের অনুকূলে নিরংকুশভাবে বাজেয়াপ্তকৃত পণ্য বোর্ড, বিধি সাপেক্ষে, যেভাবে চাহিবে সেভাবে ব্যবস্থাপনা করিতে পারিবে৷
                  </p>
                </div>
              </div>
            </div>
