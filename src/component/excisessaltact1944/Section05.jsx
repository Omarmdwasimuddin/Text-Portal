            ...
            <div className="p-6">
              <div className="space-y-6 text-justify text-black">
                ...
                <p className="mb-4 text-sm">
                  <span className='text-sm font-bold leading-tight text-black md:text-sm'>5.Omitted</span>--- [Power of Government to impose Customs duty on goods mentioned in the First Schedule.- Omitted by section 3 and the Second Schedule of the Bangladesh Laws (Revision And Declaration) Act, 1973 (Act No. VIII of 1973).]
                </p>
              </div>
