            ...
            <div className="p-6">
              <div className="space-y-6 text-justify text-black">
                ...
                <p className="mb-4 text-sm">
                  <span className='text-sm font-bold leading-tight text-black md:text-sm'>3C. Principle for determination of tariff classification---</span> When for any reason, goods are, prima facie, classifiable under two or more headings of the First Schedule, the heading which provides the most specific description shall be preferred to headings providing a more general description.
                </p>
              </div>
