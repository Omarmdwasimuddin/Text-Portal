            ...
            <div className="p-6">
              <div className="space-y-6 text-justify text-black">
                ...
                <p className="mb-4 text-sm">
                  <span className='text-sm font-bold leading-tight text-black md:text-sm'>7. Form and conditions of licence---</span> Every licence under section 6 shall be granted for such area, if any, for such period, subject to such restrictions and conditions, and in such form and containing such particulars, as may be prescribed.
                </p>
              </div>
