          ...
          <div className="flex flex-col md:flex-row">
            <div className="p-6">
                <div className="space-y-6 text-justify text-black">
                    ...
                    <div>
                        <p className="mb-4">
                            <span className="text-xl font-bold leading-tight text-gray-950 md:text-xl">৫০৷ যে সকল অপরাধের ক্ষেত্রে বিনা পরওয়ানায় গ্রেফতার করা যাইবে না---</span> <sup className='text-blue-500 cursor-pointer' title='“Code of Criminal Procedure” শব্দগুলি “Code of Criminal Procedure, 1898 (Act V of 1898), অতঃপর Code of Criminal Procedure বলিয়া উল্লিখিত,” শব্দগুলি, কমাগুলি, বন্ধনী ও সংখ্যাগুলির পরিবর্তে  অর্থ আইন, ১৯৯৬ (১৯৯৬ সনের ১৮ নং আইন) এর ৬ ধারাবলে প্রতিস্থাপিত'>১</sup>[Code of Criminal Procedure] এ যাহা কিছুই থাকুক না কেন, ধারা ৩৭ এ উল্লিখিত অপরাধসমূহের ক্ষেত্রে অপরাধীকে উক্ত Code এর আওতায় বিনা পরওয়ানায় গ্রেফতার করা যাইবে না৷
                        </p>
                    </div>
                </div>
            </div>
