          ...
          <div className="flex flex-col md:flex-row">
            <div className="p-6">
              <div className="space-y-6 text-justify text-black">
                ...
                <div>
                  <p className="mb-4">
                    <span className="text-xl font-bold leading-tight text-gray-950 md:text-xl"><sup className='text-blue-500' title='‘‘নিবন্ধন বা টার্নওভার তালিকাভুক্ত ব্যতীত” শব্দগুলি “ নিবন্ধন ব্যতীত” শব্দগুলির পরিবর্তে অর্থ আইন, ২০১৫ (২০১৫ সনের ১০ নং আইন) এর ৬৭ ধারাবলে প্রতিস্থাপিত ।'>১</sup>১৯ক। [নিবন্ধন বা টার্নওভার তালিকাভুক্ত ব্যতীত] টেন্ডারে অংশগ্রহণে বিধি-নিষেধ, ইত্যাদি---</span><sup className='text-blue-500 cursor-pointer' title='ধারা ১৯ক অর্থ আইন, ১৯৯৭ (১৯৯৭ সনের ১৫ নং আইন) এর ৭ ধারাবলে সন্নিবেশিত'>২</sup>[ <sup className='text-blue-500 cursor-pointer' title='"নিবন্ধন বা টার্নওভার তালিকাভুক্ত ব্যতীত" শব্দগুলি "নিবন্ধন ব্যতীত" শব্দগুলির পরিবর্তে অর্থ আইন, ২০০৯ (২০০৯ সনের ৩৬ নং আইন) এর ৫৩ ধারাবলে প্রতিস্থাপিত যাহা ১ জুলাই ২০০৯ তারিখ হইতে কার্যকর।'>৩</sup>[নিবন্ধন বা টার্নওভার তালিকাভুক্ত ব্যতীত] নিবন্ধন ব্যতীত কোন ব্যক্তি কোন টেন্ডারে অংশগ্রহণ করিতে পারিবেন না বা তাহার অনুকূলে কোন কার্যাদেশ প্রদান করা যাইবে না।]
                  </p>
                </div>
              </div>
            </div>
