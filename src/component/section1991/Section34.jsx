        ...
        <div className="">
          <div className="flex flex-col md:flex-row">
                ...
                <div className="space-y-6 text-justify text-black">
                    ...
                    <div>
                    <p className="mb-4">
                        <span className="text-xl font-bold leading-tight text-gray-950 md:text-xl">৩৪৷ নথিপত্র ইত্যাদি পেশকরণ---</span>যে কোন সময় কোন মূল্য সংযোজন কর কর্মকর্তা এতদুদ্দেশ্যে নির্দেশ দান করিলে কোন নিবন্ধিত ব্যক্তি তাহার অধিকার বা নিয়ন্ত্রণাধীন <sup className='text-blue-500 cursor-pointer' title='নথিপত্র, বাণিজ্যিক দলিলাদি, ইত্যাদি'>১</sup>[নথিপত্র, বাণিজ্যিক দলিলাদি, ইত্যাদি] নথিপত্র উক্ত কর্মকর্তার নিকট পেশ করিতে বাধ্য থাকিবেন৷
                    </p>
                    </div>
                </div>
                </div>
