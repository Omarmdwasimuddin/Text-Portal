                ...
                <div>
                    <p className="mb-4">
                        <span className="text-xl font-bold leading-tight text-gray-950 md:text-xl">
                            ৬১৷ আদালতের এখ্‌তিয়ার বারিত---
                        </span>
                        এই আইনের অধীন প্রদত্ত কোন আদেশ, অথবা কোন মূল্য সংযোজন কর বা, ক্ষেত্রমত, মূল্য সংযোজন কর ও সম্পূরক শুল্ক নিরুপণ, ধার্যকরণ বা আদায়করণ বাতিল বা পরিবর্তন করার জন্য কোন দেওয়ানী আদালতে কোন মামলা দায়ের করা যাইবে না৷
                    </p>
                </div>
            </div>
        </div>
