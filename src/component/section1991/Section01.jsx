          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="md:w-3/5 p-6">
              <div className="space-y-6 text-gray-700">
                ...
                <div>
                  <p className="mb-4">
                    <span className="font-semibold">১৷</span> (১) এই আইন <Link href="/regulations/acts/vat-acts/value-added-tax-act" className='text-blue-500'> সংযোজন কর আইন, ১৯৯১</Link> নামে অভিহিত হইবে৷
                  </p>
