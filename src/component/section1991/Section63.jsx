            ...
            <div className="space-y-6 text-justify text-black">
                <div>
                    <p className="mb-4">
                        ...
                        এই আইনের অধীন নিবন্ধিত মৃত ব্যক্তির করদায়িতা তাহার উত্তরাধিকারীগণ কর্তৃক তাহার নিকট হইতে উত্তরাধিকার সূত্রে প্রাপ্ত সম্পত্তির উপর অগ্রগণ্য দায় বলিয়া বিবেচিত হইবে৷
                    </p>
                </div>
            </div>
        </div>
