            ...
            <div className="space-y-6 text-justify text-black">
                <div>
                    <p className="mb-4">
                        ...
                        এই আইনের বিধানাবলী কার্যকর করার ক্ষেত্রে কোন অসুবিধা দেখা দিলে সরকার উক্ত অসুবিধা দূরীকরণার্থ, আদেশ দ্বারা, প্রয়োজনীয় যে কোন ব্যবস্থা গ্রহণ করিতে পারিবে৷
                    </p>
                </div>
            </div>
        </div>
