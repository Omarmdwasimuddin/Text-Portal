        ...
        <div className="">
          <div className="flex flex-col md:flex-row">
            ...
            <div className="space-y-6 text-justify text-black">
                ...
                <div>
                <p className="mb-4">
                    <sup className='text-blue-500 cursor-pointer' title='ধারা ৩৬ক অর্থ আইন, ২০১১ (২০১১ সনের ১২ নং আইন) এর ৭২ ধারাবলে সন্নিবেশিত।'>১</sup>[<span className="text-xl font-bold leading-tight text-gray-950 md:text-xl">৩৬ক। মুল্য সংযোজন কর সম্মাননাপত্র---</span> (১) পূর্ববর্তী অর্থ বৎসরের সকল দাখিলপত্র পেশকারী ব্যক্তি মূল্য সংযোজন কর সম্মাননাপত্র লাভের অধিকারী হইবেন;
                </p>
