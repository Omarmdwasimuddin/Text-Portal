            ...
            <div className="space-y-6 text-justify text-black">
                <div>
                    <p className="mb-4">
                        ...
                        এই আইন বা কোন বিধির অধীনে সরল বিশ্বাসে কৃত কোন কার্যের ফলে কোন ব্যক্তি ক্ষতিগ্রস্ত হওয়ার সম্ভাবনা থাকিলে তজ্জন্য সরকার বা উহার কোন কর্মকর্তার বিরুদ্ধে কোন দেওয়ানী বা ফৌজদারী মামলা বা অন্য কোন আইনগত কার্যধারা দায়ের বা রুজু করা যাইবে না৷
                    </p>
                </div>
            </div>
        </div>
