          ...
          <div className="flex flex-col md:flex-row">
            <div className="p-6">
                <div className="space-y-6 text-justify text-black">
                    ...
                    <div>
                        <p className="mb-4">
                             <span className="text-xl font-bold leading-tight text-gray-950 md:text-xl">৪৩৷ বোর্ডের নথিপত্র, ইত্যাদি তলব ও পরীক্ষার ক্ষমতা---</span>(১) বোর্ড স্বতঃপ্রবৃত্ত হইয়া এই আইনের অধীন কোন কার্যধারার নথিপত্র, উহাতে বোর্ডের অধস্তন কোন মূল্য সংযোজন কর কর্মকর্তা কর্তৃক প্রদত্ত আদেশ বা সিদ্ধান্তের বৈধতা বা ন্যায্যতা সম্পর্কে সন্তুষ্ট হওয়ার উদ্দেশ্যে, তলব ও পরীক্ষা করিতে পারিবে এবং উহা তত্সম্পর্কে যেরূপ বিবেচনা করে সেইরূপ আদেশ দান করিতে পারিবে:
                        </p>
