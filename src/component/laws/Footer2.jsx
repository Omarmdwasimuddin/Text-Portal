      ...
      <div className="relative container mx-auto max-w-7xl px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-10 z-10">
        ...
        >
          ...
          <p className="text-sm leading-relaxed opacity-80 hover:opacity-100 transition-all duration-300">
            মূল্য সংযোজন কর আইন, ১৯৯১ বাংলাদেশের কর কাঠামোর একটি গুরুত্বপূর্ণ অধ্যায়। 
            এই আইনের মাধ্যমে পণ্য ও সেবার উপর মূল্য সংযোজন কর আরোপ, করহার নির্ধারণ, 
            নিবন্ধন প্রক্রিয়া এবং কর পরিশোধের নিয়মাবলী সুস্পষ্টভাবে বর্ণনা করা হয়েছে। 
            ব্যবসায়ী, প্রতিষ্ঠান এবং সাধারণ করদাতাদের জন্য এটি কর প্রদানে দিকনির্দেশক ভূমিকা পালন করে।
          </p>
        </motion.div>
