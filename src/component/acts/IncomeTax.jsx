...
const lawsData = [
  { 
    id: 1, 
    title: "Authentic English Text (Income Tax Act, 2023)", 
    slug: "authentic-english-text-income-tax-act-2023",
    pdfUrl: "/pdfs/3190-SRO-404-NBR-16_October_2025(10455-10741).pdf"
  },
  { 
    id: 2, 
    title: "আয়কর (সংশোধন) অধ্যাদেশ-৫৯, ২০২৫", 
    slug: "customs-act-1969-amended",
    pdfUrl: "/pdfs/অধ্যাদেশ_নং-৫৯,_২০২৫.pdf"
  },
  { 
    id: 3, 
    title: "অর্থ সংক্রান্ত কতিপয় আইন (দ্বিতীয় সংশোধন) অধ্যাদেশ-২০২৫ (অধ্যাদেশ নং-৫২, ২০২৫)", 
    slug: "customs-act-2023-amended",
    pdfUrl: "/pdfs/অধ্যাদেশ-52,_2025.pdf"
  },
  { 
    id: 4, 
    title: "আয়কর আইন, ২০২৩ (ইংরেজি)", 
    slug: "customs-act-2023",
    pdfUrl: "/pdfs/Income_tax_act_2023.pdf"
  },
  { 
    id: 5, 
    title: "আয়কর আইন, ২০২৩", 
    slug: "income-tax-act-2023",
  },
  { 
    id: 6, 
    title: "IT Ordinance, 1984 as amended up to July,2015", 
    slug: "it-ordinance-1984-amended",
  },
];
...
export default function LawsPage() {
  ...
  const handleLawClick = (law) => {
    ...
    // যদি PDF না থাকে কিন্তু slug আছে
      ...
      router.push(`/regulations/acts/income-tax/${law.slug}`);
    }
  };
        ...
        <div className="overflow-hidden bg-white border border-gray-200 shadow-lg rounded-2xl">
          <div className="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-green-600 to-green-600">
            <div className="flex items-center justify-between">
              <h2 className="text-lg text-white">আয়কর আইন</h2>
