...
const lawsData = [
  { id: 1, title: "Authentic English Text (Customs Act, 2023)", slug: "value-added-bekhapotro" },
  { id: 2, title: "Customs Act-1969 (Amendment)(Again Upoaded)", slug: "value-added-tax-act" },
  { id: 3, title: "Customs Act-2023 (Amendment)(Again Upoaded)", slug: "value-added-tax-and-supplementary-duty-act" },
  { id: 4, title: "Customs Act-2023", slug: "Income-tax-ordinance" },
  { id: 5, title: "Customs Act-1969 (English)", slug: "customs-acts-1969-english"},
  { id: 6, title: "Customs Act-1969 (Bangla)", slug: "customs-acts-1969-bangla"},
  { id: 7, title: "Customs Act-2014", slug: "customs-acts-1969-english"},
];
        ...
        <div className="overflow-hidden bg-white border border-gray-200 shadow-lg rounded-2xl">
          <div className="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-green-600 to-green-600">
            <div className="flex items-center justify-between">
              <h2 className="text-xl text-white">Customs Acts</h2>
