              ...
              <div className="py-2 text-black bg-gradient-to-r from-green-500 to-green-500 md:px-8">
                ...
                <div>
                  <p className="mb-4 text-lg">
                    <span className='text-xl font-bold leading-tight text-gray-950 md:text-xl'>৩০। রপ্তানির নিমিত্ত আমদানি---</span><sup className='text-blue-500' title='ধারা ২৭ অর্থ আইন, ২০১৯ (২০১৯ সনের ১০ নং আইন) এর ৬৭ ধারাবলে প্রতিস্থাপিত।'>১</sup>কোন পণ্য বাংলাদেশের অভ্যন্তরে ভোগের উদ্দেশ্যে খালাস বা ছাড় না করিয়া রপ্তানির উদ্দেশ্যে আনয়ন করা হইলে, উক্ত পণ্য করযোগ্য হইবে না।
                  </p>
