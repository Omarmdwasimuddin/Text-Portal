              ...
              <div className="py-2 text-black bg-gradient-to-r from-green-500 to-green-500 md:px-8">
                ...
                <div>
                  <p className="mb-4 text-lg">
                    <span className='text-xl font-bold leading-tight text-gray-950 md:text-xl'>৩। আইনের প্রাধান্য---</span>আপাতত বলবৎ অন্য কোন আইন, বিধি, প্রবিধান বা আইনের ক্ষমতাসম্পন্ন অন্য কোনো দলিলে যাহা কিছুই থাকুক না কেন, এই আইনের বিধানাবলী প্রাধান্য পাইবে।
                  </p>
                </div>
