              ...
              <div className="py-2 text-black bg-gradient-to-r from-green-500 to-green-500 md:px-8">
                ...
                <div>
                  <p className="mb-4 text-lg">
                    <span className='text-xl font-bold leading-tight text-gray-950 md:text-xl'>১৬। মূল্য সংযোজন কর পরিশোধে দায়ী ব্যক্তি---</span>নিম্নবর্ণিত ব্যক্তিকে মূসক প্রদান করিতে হইবে, যথা:―
                  </p>
                  ...
                  <p className='mb-4 ml-10 text-lg'>
                    <sup className='text-blue-500'title='দফা (ঘ) অর্থ আইন, ২০১৯ (২০১৯ সনের ১০ নং আইন) এর ৬৩ ধারাবলে প্রতিস্থাপিত।'>১</sup>[(ঘ) অন্যান্য ক্ষেত্রে: সরবরাহকারী বা সরবরাহগ্রহণকারী।]
                  </p>
