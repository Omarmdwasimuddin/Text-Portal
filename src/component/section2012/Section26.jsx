              ...
              <div className="py-2 text-black bg-gradient-to-r from-green-500 to-green-500 md:px-8">
                ...
                <div>
                  <p className="mb-4 text-lg">
                    <span className='text-xl font-bold leading-tight text-gray-950 md:text-xl'>২৬। অব্যাহতিপ্রাপ্ত সরবরাহ বা অব্যাহতিপ্রাপ্ত আমদানি---</span>এই আইনে যাহা কিছুই থাকুক না কেন, নিম্নবর্ণিত সরবরাহসমূহ মূসক অব্যাহতিপ্রাপ্ত হইবে, যথা:―
                  </p>
                  ...
                  <p className='mb-4 ml-10 text-lg'>
                    (খ) অব্যাহতিপ্রাপ্ত সরবরাহ গ্রহণের অধিকার (right) বা ভবিষ্য ক্রয় বা বিক্রয়ের অধিকার (option) সংক্রান্ত সরবরাহ।
