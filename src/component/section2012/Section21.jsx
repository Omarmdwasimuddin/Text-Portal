              ...
              <div className="py-2 text-black bg-gradient-to-r from-green-500 to-green-500 md:px-8">
                ...
                <div>
                  <p className="mb-4 text-lg">
                    <span className='text-xl font-bold leading-tight text-gray-950 md:text-xl'>২১। শূন্যহার বিশিষ্ট সরবরাহ---</span>(১) এই আইনে যাহা কিছুই থাকুক না কেন, নিম্নবর্ণিত সরবরাহের ক্ষেত্রে মূসক হার হইবে শূন্য, যথা:―
                  </p>
                  ...
                  <p className='mb-4 ml-20 text-lg'>
                    (খ) শূন্যহার বিশিষ্ট সরবরাহ গ্রহণের অধিকার (right) বা ভবিষ্য ক্রয় বা বিক্রয়ের অধিকার (option) সংক্রান্ত সরবরাহ।
                  </p>

                  <p className='mb-4 ml-10 text-lg'>
                    (২) যদি কোন সরবরাহ অব্যাহতিপ্রাপ্ত এবং শূন্যহারবিশিষ্ট উভয়ই হয়, তাহা হইলে এই উপ-ধারার আওতায় সরবরাহটি অব্যাহতিপ্রাপ্ত না হইয়া শূন্যহার বিশিষ্ট হইবে।
                  </p>
