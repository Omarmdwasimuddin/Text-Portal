              ...
              <div className="py-2 text-black bg-gradient-to-r from-green-500 to-green-500 md:px-8">
                ...
                <div>
                  <p className="mb-4 text-lg">
                    <span className='text-xl font-bold leading-tight text-gray-950 md:text-xl'>৩২ক। বোর্ড কর্তৃক ব্যাখ্যা প্রদান---</span><sup className='text-blue-500' title='ধারা ৩২ক অর্থ আইন, ২০১৯ (২০১৯ সনের ১০ নং আইন) এর ৭১ ধারাবলে সন্নিবেশিত।'>১</sup>বোর্ড এই আইনের উদ্দেশ্য পূরণকল্পে, সরকারি গেজেটে প্রজ্ঞাপন দ্বারা করযোগ্য যে কোন সেবার পরিধি নির্ধারণের লক্ষ্যে কিংবা অন্য যে কোন বিষয়ে ব্যাখ্যা প্রদান করিতে পারিবে।
                  </p>
        ...
        <div className="">
          <div className="p-6">
            ...
            <p className="text-xs italic text-gray-900">
              ১ ধারা ৩২ক অর্থ আইন, ২০১৯ (২০১৯ সনের ১০ নং আইন) এর ৭১ ধারাবলে সন্নিবেশিত।<br/>
            </p>
          </div>
        </div>
