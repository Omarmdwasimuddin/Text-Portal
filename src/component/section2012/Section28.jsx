              ...
              <div className="py-2 text-black bg-gradient-to-r from-green-500 to-green-500 md:px-8">
                ...
                <div>
                  <p className="mb-4 text-lg">
                    <span className='text-xl font-bold leading-tight text-gray-950 md:text-xl'>২৮। করযোগ্য আমদানির মূসক আরোপযোগ্য ভিত্তিমূল্য নির্ধারণ---</span><sup className='text-blue-500' title='ধারা ২৭ অর্থ আইন, ২০১৯ (২০১৯ সনের ১০ নং আইন) এর ৬৭ ধারাবলে প্রতিস্থাপিত।'>১</sup>[কোন করযোগ্য আমদানির ক্ষেত্রে মূসক আরোপের ভিত্তিমূল্য হইবে নিম্নবর্ণিত পরিমাণের সমষ্টি, যথা:-
                  </p>
        ...
        <div className="">
          <div className="p-6">
            ...
            <p className="text-xs italic text-gray-900">
              ১ ধারা ২৮ অর্থ আইন, ২০১৯ (২০১৯ সনের ১০ নং আইন) এর ৬৮ ধারাবলে প্রতিস্থাপিত।<br/>
            </p>
          </div>
        </div>
